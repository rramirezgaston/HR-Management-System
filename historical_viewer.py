            ...
            for candidate in all_candidates:
                ...
                if is_future_view:
                    ...
                    if is_cleared:
                        ...
                        missing_items = []
                        if not candidate['bg_ds_clear']:
                            missing_items.append("BG/DS Clear")
                        if not candidate['pre_board_complete']:
                            missing_items.append("Pre-Board")
                        if not candidate['myinfo_ready']:
                            missing_items.append("MyInfo Ready")
                        if not candidate['pn_number'] or not candidate['euid']:
                            missing_items.append("PN/EUID")
